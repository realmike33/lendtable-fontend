...
function SigninForm({ error, onSubmit, onChange }: { error: boolean; onSubmit: Function; onChange: Function }) {
  ...
  return (
    <Form size="large" onSubmit={() => onSubmit(userInfo)} error={error}>
      ...
      <Message error={error} warning header="Could Not Signin!" content="Try again or signup for an account." />
    </Form>
  )
}
